...
namespace Big_Smoke
{
    public class ClsCarrito
    {
        ...
        {
            da = new MySqlDataAdapter("tspListarUsu();", cadeConexion);
            ds = new DataSet();
        ...
        {
            da = new MySqlDataAdapter("tspListaProductos();", cadeConexion);
            ds = new DataSet();
        ...
        {
            da = new MySqlDataAdapter("spListarCompras("+opc+");", cadeConexion);
            ds = new DataSet();
        ...
        {
            da = new MySqlDataAdapter("bibliotecaUs('" + op + "','" + clave + "');", cadeConexion);
            ds = new DataSet();
